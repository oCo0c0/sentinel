...
public class TransportConfigTest {
    ...
    public void testGetConsoleServerList() {
        ...
        // mixed
        SentinelConfig.setConfig(TransportConfig.CONSOLE_SERVER, "www.dashboard.org:81,112.13.223.3,112.13.223.4:8089,www.dashboard.org");
        list = TransportConfig.getConsoleServerList();
        assertNotNull(list);
        ...
        assertEquals(8089, list.get(2).getPort());
        ...
        SentinelConfig.setConfig(TransportConfig.CONSOLE_SERVER, "https://www.dashboard.org,http://www.dashboard.org:8089,www.dashboard.org,www.dashboard.org:8089");
        list = TransportConfig.getConsoleServerList();
        assertNotNull(list);
        assertEquals(4, list.size());
